    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField()),
                ('image_feild', models.ImageField(upload_to='product_image')),
                ('category', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='drf.category')),
            ],
        ),
    ]
